...
**CORRECTION (same night, next session):** The original version of this item claimed the book has no law-enforcement section. That was wrong — it was written against a stale reading copy. The current main branch has both `where-the-police-fit.md` (a full container-side protocol: removal vs. reporting, the 911 threshold in the promise, prosecutor mechanics, the ten-point local-law checklist) and the "Know Where the Law Actually Stands" section in `when-youve-been-wronged.md` (the threatened person's side: intent requirements, PC 422, fear-inversion). The legal lane is well covered. What survives of the item is one narrower candidate:

- [ ] **Candidate addition: filing late still protects the next person.** Neither chapter currently makes the point that a report on file makes the *next* victim more likely to be believed — police and prosecutors check prior contact history, and a documented pattern changes charging and credibility decisions. Statutory hooks (verified against the statutes, still worth a citation pass before print): California Evidence Code §1101(b) admits prior acts to prove intent/plan/absence of mistake; §1108/§1109 admit prior acts as propensity evidence in sexual-offense and domestic-violence cases; course-of-conduct crimes (e.g. stalking, PC 646.9) are built from documented prior incidents. The "more likely to be believed" claim is established practice rather than statute — mark as investigate/cite before print. Natural home: a short passage in `where-the-police-fit.md` near the statute-of-limitations paragraph ("It just gets lighter the longer it waits"), or in "Know Where the Law Actually Stands." Fits the book's existing frame: the record is the product, not the catharsis — it works by existing, and it protects people the reporter will never meet. Also pairs with the honest caveat the chapters already carry: most reports don't lead to charges and the reporter usually never hears back.
