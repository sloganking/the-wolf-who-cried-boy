...
The same is true for the [stories that run your filters](./trauma-and-filters.md). They're generated by processes bigger than your conscious mind — your subconscious, your predictions, the patterns that tell your [RAS](./trauma-and-filters.md#stories-control-attention) what to see and what to ignore. Changing what you see isn't a matter of deciding to believe something else. It's the same retraining: your nervous system has been running the old program for years. To see a different world, you have to practice the new one until it gets strong enough to override the old. Fawning is one instance of that. So is every automatic story you're trying to change.
