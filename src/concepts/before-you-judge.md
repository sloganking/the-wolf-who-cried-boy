...
1. Person A wrongs Person B (or B _believes_ they were wronged)
2. Person B gets very angry, treats it as [high severity](./severity.md)
3. Person A [fawns](./fawning.md), apologizes, appeases
...
(For the full story of how this practice became normalized—and why it's a prime example of [Rescuer harm at scale](./why-rescuers-are-dangerous.md#case-study-circumcision)—see the case study.)
...
- **Most "predators"** — [righteous predators](./why-rescuers-are-dangerous.md#rescuers-with-harmful-beliefs-the-righteous-predator). People operating from harmful beliefs they've never questioned. They genuinely think they're in the right. They're causing harm while feeling like heroes.
...
(Yes, there are people for whom selfishness comes easy—and they tend to prefer it. But 9 out of 10 people reading this right now would have a comically painful time doing one thing they genuinely perceived as selfish. And if they managed it, the [sinsickness](./i-made-a-mistake.md#sinsickness) alone might destroy them.)
...
When someone [fawns](./fawning.md) after being accused or confronted:
...
3. Recognize when the "victim" may be [over-responding](./appropriate-response.md)
...
- [Appropriate Response](./appropriate-response.md) — Can't respond appropriately without good info
- [Fawning](./fawning.md) — Apology ≠ guilt
- [Trauma & Filters](./trauma-and-filters.md) — Anger ≠ justification
- [Severity](./severity.md) — Can't assess without knowing what happened
