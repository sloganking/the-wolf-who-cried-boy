...
<a id="your-voice-matters"></a>

This matters most when an angry crowd turns on someone. In [a famous psychology experiment](https://cruciallearning.com/blog/how-to-speak-up-and-listen-at-work-crucial-learning/), researchers showed a group of people a line and asked them to match it to one of three options. The researchers designed it so the correct answer was obvious at first glance — but everyone in the room except one person was an actor, told to confidently give the wrong answer. About two-thirds of the real test subjects went along with the group's wrong answer, even though they could see it was wrong. Most people will not contest the conclusion the group seems to be reaching, even when they can see it's wrong.
...
**1. Own the determining factor first.**
...
- [Repair](./repair.md) — Taking responsibility in action
