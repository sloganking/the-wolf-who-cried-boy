...
The experience happens. The feeling arrives. It seems like the experience _caused_ the feeling directly.
...
Your attention lands on the positive aspect or the negative one, and that becomes the whole picture to you. And it doesn't stop at perception — the side you land on becomes the belief you act from. You think the facts made you feel and act the way you did; really, the half you focused on did. You can be completely accurate and still be working from half the truth — **factually selective**, right about your slice and blind to the rest.
...
The content you consume — the horror, scary news, the predator-hunting feeds — isn't the only thing that primes your filter. You already know the other one from the inside.
...
And you can't argue with him. Not because he's stubborn — because his reasoning actually works. If everyone *does* want what you have, then the giant *is* a weapon, the ceasefire *is* a trap, and launching the missile *is* the only move. Every conclusion follows from the premise. In logic, that's called **valid** — the structure of the argument is correct. The problem is the premise itself. Kent's premise is false. So his conclusions are **valid but unsound** — fear-driven reasoning that looks airtight from the inside, built on a foundation that isn't real. You can't reach him by attacking his logic. His logic works. You'd have to reach underneath it and pull out the belief he doesn't know is a belief — and he'd fight you every step of the way, because it doesn't feel like a belief to him. It feels like the way the world is.
...
The Inquisitor feared heretics destroying civilization—so he destroyed lives. The Rescuer feared a predator in the community—so she destroyed a reputation. The parent feared their child wouldn't be strong enough to survive a harsh world—so they [became the harsh world](../the-rescue-that-made-me-see.md). Every one of them a [righteous predator](./why-rescuers-are-dangerous.md#rescuers-with-harmful-beliefs-the-righteous-predator) — causing harm while certain they were preventing it.
...
Every surface belief you've been fighting is a [valid but unsound](#when-evidence-gets-through) conclusion — logical reasoning built on an axiom you've never examined. You can't dissolve it by arguing with the reasoning. The reasoning works. The axiom is where the error lives — and axioms are the last thing anyone examines, because they feel like bedrock, not belief.

Once you find the axiom, the surface beliefs stop looking like separate problems and start looking inevitable. *Of course* someone who believes "my needs are too much" keeps ending up with the wrong person. *Of course* someone who believes "I'll be abandoned if I displease anyone" can't say no. The behavior isn't the problem. The axiom is. Anyone with that axiom would do the same thing.
