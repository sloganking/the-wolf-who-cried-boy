...
- **The tool isn't filed.** People reach for the tools they're used to. Someone who has never called the police for anything doesn't have "call the police" filed in their head as an available action — and the book has already shown what happens to options that aren't filed: [the choice was never on the menu](./trauma-and-filters.md#try-this-right-now). The call isn't rejected. It never comes up.
...
"Pressing charges" describes something that doesn't exist. Everywhere in the United States, the decision to formally accuse someone of a crime — to *charge* them — belongs to the prosecutor: the government's lawyer, who works for the state, not for either person involved. You don't file charges, and you can't drop them.

What a call actually starts is a chain of checkpoints, none of which the caller controls. Officers arrive and assess what they find. The visit ends one of three ways: the person is removed, the person is arrested, or a written report goes on file. An arrest ends the night — it doesn't decide anyone's fate. Whether anything happens after that is the prosecutor's decision, and guilt is a court's decision after *that*, each step requiring more proof than the one before. A prosecutor who can't prove a case doesn't bring it — and in a threats case, the threatened person's own account is often most of the evidence, so declining to participate can end a case. *Can*, not *will*. Whether it does is still the prosecutor's call.

Those checkpoints also mean the system doesn't move on its own. Police have no legal duty to investigate any given report, and prosecutors spend their limited hours on the most serious cases first — some offices close minor cases without ever reviewing them unless the person who reported calls to follow up. So television's other story — *report it and the government takes it from here* — is as fictional as "pressing charges." For anything less than the most serious threats, a report nobody pushes can sit as a report forever. That's not the system failing. It's the system doing what this book teaches — [matching the response to the severity](./appropriate-response.md) — with government hours instead of yours. And it's one more reason the after-the-fact choice belongs to the person who was threatened: below the most serious tier, there is no case unless they carry it.
