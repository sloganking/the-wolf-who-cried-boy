...
What exists for exactly this situation is a phone call: *"Someone is refusing to leave my property."* That's not reporting a crime. It's not an accusation, a case, or a verdict on anyone's character. It's a removal — a trespass problem, the same call a restaurant makes at closing time. Once the person with lawful control of the space — which can be you as the event's host, depending on your venue agreement — has told someone to leave, staying becomes the offense, and removing them becomes something police handle without anyone deciding anyone's guilt. What you lead with shapes the encounter but doesn't determine it: officers who arrive for a removal and find evidence of a serious crime can act on it regardless of why they were called.

And above the removal call sits the one threshold that isn't a judgment call at all: someone moving toward violence, not just threatening it. That call is 911 — and [the promise already made it](./before-you-facilitate.md#example-how-to-present-this), before the container started, precisely so no one would have to make it in the moment. Law-enforcement thresholds are the fire exits of a container: located before the event, hopefully never used, known cold. Located, they work the way the promise works everywhere else — [the decision was made before the fear showed up](./before-you-facilitate.md#when-the-facilitator-is-the-target). Unlocated, the question gets asked for the first time in the middle of the crisis it exists to answer, by a facilitator who is afraid, in front of a watching room — the exact conditions that produce [fawning instead of facilitating](./before-you-facilitate.md#when-the-facilitator-fawns). And a container everyone knows will never call, no matter what, has told its most dangerous member exactly how far things can go.
