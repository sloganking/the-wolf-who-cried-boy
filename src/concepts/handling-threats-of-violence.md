...
What a call to the police actually starts is a chain of hands. The caller's is the first one — and the only one they hold. Nothing in the chain moves until somebody tells the police it happened; nobody comes asking. Officers arrive and handle what's in front of them — the night ends with the person walked off the property, the person arrested, or a written report on file. Even an arrest only ends the night. It doesn't decide anyone's future: whether a case opens at all is the prosecutor's call, and guilt is a court's call after that, with each hand needing more proof than the one before. What opens a case is proof — and a threat leaves nothing physical behind. What proves it is the people who heard it, starting with the person it was aimed at. So a threatened person who won't tell their story *can* end a case right there — but even that isn't guaranteed: whether to keep going without them is, again, the prosecutor's decision.
