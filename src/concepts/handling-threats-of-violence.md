...
7. **Whether anyone on your team is legally required to report.** Staying silent about a crime you witnessed generally isn't itself a crime — there's no general duty to report, and the laws that come closest require actively hiding something, not simply not speaking. The exception is role-based: states designate professions that *must* report suspected abuse of protected groups — commonly licensed therapists and counselors, health practitioners, social workers, clergy, and anyone in a caretaking role, with the protected groups being minors, elders, and adults with physical or mental limitations. The trigger is reasonable suspicion, not proof, and the duty holds whether or not the affected person wants a report made. These spaces are full of therapists and bodyworkers. If one of them is on your team, the law drew their line for them — and both of you need to know that before the container opens, not while it's happening.
