...
If someone who made threats refuses to leave, repeating the script louder doesn't change anything — the script's power was the agreements, and this person has stopped caring about them. If your event has security, they can escort the person off the property — and not just by asking. The law behind a bouncer removing someone from a bar is general American law, not a bar privilege: once the person in control of a property says *leave* and someone refuses, reasonable force to remove them is allowed — proportionate to the resistance it meets, never deadly, and it ends the moment they're out. And that is the whole of security's authority: a guard is the property owner's agent, with the same legal powers as any other private person — the uniform adds nothing. So when a removal would take a real fight, professional security calls the police — that's the industry's own standard, because force past *reasonable* makes the guard the one breaking the law. A facilitation team without security runs the same sequence minus the middle step: when words stop working, the next move is calling the police.
