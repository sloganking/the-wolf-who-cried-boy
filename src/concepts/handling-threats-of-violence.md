...
That's the whole public version — and the second sentence is the one that gets cut, because saying it out loud feels like importing fear into a room that came for something else. It works the other way. A safety briefing naming interference with a flight crew as a federal offense doesn't put a hijacking in anyone's head; it names a behavior, and a named behavior only sounds like a threat to someone weighing it. That's who it's for. Someone who believes that standing up for a person in the room can't cost them more than a raised voice is missing the fact that would change what they do next — and the only moment they can still use it is before anything has happened.
