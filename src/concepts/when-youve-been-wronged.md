...
- **Someone [over-responded](./appropriate-response.md) to your mistake.** You made a LOW or MEDIUM mistake — an accidental boundary crossing, a miscommunication — and the response was HIGH-severity: public attacks on your reputation, accusations you didn't deserve, attempts to exile you from your community. A [righteous predator](./why-rescuers-are-dangerous.md#rescuers-with-harmful-beliefs-the-righteous-predator) decided you were the villain and mobilized the room. The harm from their response dwarfed the harm from your original mistake. This is [top vulnerability](./all-power-is-mutual.md#top-and-bottom-vulnerability) — you're in the unprotected position, with no safeword and no one mobilizing to help you.
...
Death threats are a different story. California calls them criminal threats (Penal Code 422): willfully threatening death or great bodily injury, intending it to be taken as a threat — whether or not you'd ever carry it out — in a way that puts someone in sustained fear. It can be charged as a felony: up to three years in prison, and a strike under the three-strikes law. The usual weak point in a threat case isn't the law — it's proof. A threat made in private collapses into one person's word against another's. A threat made in front of a room full of witnesses doesn't have that problem: the same audience that made the attack so public is what makes it undeniable. If the threats against you happened without witnesses, that's not a dead end — it's one more reason to [document what actually happened](#document-what-actually-happened) while it's fresh, including who saw or heard anything at all. And if you hold containers yourself, the facilitator's side of this decision — when a container calls, who decides, and what a call actually starts — is [its own protocol](./handling-threats-of-violence.md#the-fire-exits-where-the-police-fit).
...
Laws differ by state and country, and this isn't legal advice — if you're facing real accusations, talk to a real lawyer. The specifics matter less than the move: **find out where you actually stand before fear decides for you.** You may discover, as I did, that the ground you thought was collapsing is solid. You may discover more: that the law you were dreading was never pointed at you — it was pointed at the person threatening you, the whole time. I spent that moment terrified of a legal system that, had it actually entered the room, would have been *my* protection. That's how completely fear had inverted the map. I wasn't standing in a minefield. I was standing on higher ground — and fawning like I was cornered.
...
- It tells you they may have [trauma filters](./trauma-and-filters.md) that distort their perception
...
- [Drama Triangle](./drama-triangle.md) — Understanding Victim/Persecutor dynamics
- [Fawning](./fawning.md) — Don't fawn under attack
- [Taking Responsibility](./responsibility.md) — Own your part, no more, no less
- [Trauma & Filters](./trauma-and-filters.md) — Why their perception may be distorted