...
Here's what nobody in a punishment culture is thinking about: it doesn't just silence the people who made mistakes. It silences the people whose boundaries were crossed.
...
This is the same pattern described in [The Village Always Finds a Wolf](./why-rescuers-are-dangerous.md#the-village-always-finds-a-wolf): the people who see clearly get driven out, and every time one of them leaves, the average drops. Eventually you're left with a community that sees wolves everywhere, led by the person who sees the most wolves that aren't there.

---

## Protected Reporting

Everything above describes what happens when reporting is dangerous. Protected reporting is what happens when you make it safe.

The principle is simple: anyone — staff or participant — can report a mistake, a boundary crossing, a near-miss, or a red flag without that report triggering punishment. The report is information, not an accusation. The facilitator's job is to use the information to improve the container, not to weaponize it against the person being reported.
...
Protected reporting only works if three things are true:

**1. The response to a report is proportional.** If someone reports a boundary crossing and the facilitator's response is to publicly shame and remove the person who crossed it, nobody will report again. The response has to match the [severity](./severity.md) — not the fear.

**2. Reports are treated as information, not verdicts.** A report means "something happened that's worth looking at." It doesn't mean "this person is guilty." The facilitator [goes to primary sources](./before-you-judge.md#primary-sources-matter), [verifies](./before-you-judge.md#are-you-a-qualified-source) what actually happened, and becomes a [qualified source](./before-you-judge.md#are-you-a-qualified-source) before taking action. Acting on a report without verification isn't protected reporting — it's a [witch hunt](./before-you-judge.md#the-witch-hunt-dynamic).
