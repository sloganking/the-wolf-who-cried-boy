...
But you don't owe anyone the chance to repair. Maybe the pain was so large that you predict this person hasn't changed. Maybe you don't want to risk being hurt again. Maybe you just don't have it in you. That's okay. That's your choice. You can disconnect and not allow repair. [That's its own section.](#when-the-other-person-doesnt-want-contact)
...
**[Repair is not the same as responsibility](./responsibility.md#responsibility-is-not-repair).**
...
And if you go back and forth a few times and still can't find something that works for you both — don't repair with something that doesn't feel good to you just because you couldn't find something that did. Wait. Keep looking. A repair action you resent taking is worse than no repair action at all, because now the relationship carries the original harm *plus* your resentment. Hold out until you find something that genuinely feels right — or accept that the repair might need to take a different form than either of you expected. And if what they're asking for is disproportionate — if they're [narrative-locked](./invisible-patterns.md#narrative-lock) or demanding more than the harm warrants — you can hold your ground and offer what you believe is proportional. You don't have to meet a repair demand you think is an over-ask. Offer what's fair, clearly. They can accept it or not. If there's a gap between what you believe is proportional and what they need to feel complete, the relationship might not fully repair — and that's a real outcome. You can't control whether they feel done. You can control whether your offer is genuine and proportional.
...
I made a LOW-to-MEDIUM [severity](./severity.md), [unconscious mistake](./types-of-mistakes.md#why-unconscious-mistakes-happen) — crossed a boundary for about one second, stopped immediately, and apologized. She said she felt complete and didn't need anything else. I told her I didn't feel complete — that when I make a mistake, I like to make it right with actions, not just words — and asked if she'd be open to hearing what I came up with later. She didn't say no.

Then someone else in the room decided I was dangerous. They called me names in front of a room full of people. They spread stories about me that weren't true. They tried to get me removed from the space. They made death threats. Some people who had been friendly with me changed how they treated me — not because of the mistake I'd made, but because of the story this person told while they were angry. All HIGH [severity](./severity.md). That's the [Notice](../tools/notice-feel-story.md).

Their apology for all of that acknowledged exactly one wrongdoing: that they'd brought anger into it that wasn't about me — older anger, from other places, that landed on me because I was there.

Measure the distance. The aim of their anger was the only thing they named. Nothing about the names they called me. Nothing about the stories they spread. Nothing about trying to get me removed. Nothing about the death threats. In their accounting, only the anger's origin required addressing — the actions it produced went unmentioned. And the acknowledgment came at the front of a longer message that moved on to everything else they wanted to say to me — both an under-apology and a narrative-locked one: the delivery was unintentional, and the content showed they hadn't looked at the full scope of what they did.

I don't think the apology was a lie. In their version of events, they were the protector whose only error was carrying anger in from somewhere else — and an apology built on a story where you were mostly right can only be as big as the sliver of wrongdoing you've admitted to yourself. The apology wasn't deception. It was a readout. It showed me exactly how much of their own behavior they'd been able to look at: where the anger came from — not one thing the anger did. Maybe they genuinely cared and reached out with the best they had — they just [couldn't see the rest yet](./trauma-and-filters.md#stories-control-attention). That's what [narrative lock](./invisible-patterns.md#narrative-lock) does to apologies: it caps them at the size of the admitted story.

Two more tells that an apology is running on an unchanged story: language that positions the apologizer above you — the wiser one, the one who's grown — and new accusations folded into the same message. You don't need altitude over someone you're genuinely apologizing to, and you don't build a case against someone while making amends to them. Neither tell means the words "I'm sorry" are insincere. Both mean the story underneath hasn't moved — and the apology can't outgrow the story.

**What a mismatched apology creates.**

I didn't respond. Not out of spite — out of a practical read: a real conversation about what happened requires someone who has seen at least some of what happened, and the apology showed me they hadn't yet. Every recipient of an apology runs this same measurement, consciously or not. The distance between what you said and what actually happened tells them where you are. When the distance is small, even a short apology lands. When it's large, the apology communicates the opposite of what you intended — *this person hasn't looked yet* — and the door quietly closes.

**Your apology should open doors, not be so mismatched to the harm you caused that it closes them.** If you want the other person to engage, to respond, to participate in [making it right](#how-to-make-it-right) — the apology has to demonstrate that you've looked at what you did. All of it. Not the version where you were "a little too" something. The version where you name the specific actions, the specific impact, and show that you understand the full scope of the harm. That's what makes someone think *okay, this person is ready.* Anything less, and they might not even reply — not because the apology didn't reach them, but because it showed them you don't yet see what there is to apologize for.
...
- **Full attention.** Nothing else in the conversation. Nothing before it, nothing after it. Just the apology. Don't mix it with other topics. Don't pivot to your life afterward. The moment you shift your attention to something else, you've shown them where your attention actually is.
