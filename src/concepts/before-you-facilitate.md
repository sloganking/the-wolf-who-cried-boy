...
So bring the capability inside: your own specialist and your own security staff, trained before they're needed. This doesn't replace the call for imminent danger; [that threshold is decided before the container starts](./where-the-police-fit.md#when-someone-wont-leave). It covers everything below that line, including the problems that stay small enough that nobody has to call anyone, because someone skilled was already in the room.
