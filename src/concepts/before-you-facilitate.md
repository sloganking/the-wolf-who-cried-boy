...
**Think of it as insurance.** For the past year I've gone to a Tony Robbins event about once a month. At one of them, with around 15,000 people in the stadium, someone passed out. A medical team was already there, and security was everywhere. In a year of events, that was the one emergency I saw. That's the shape of this kind of risk: it shows up rarely, and when it does, everyone is watching how it's handled. Now picture the same moment with no one ready. Someone gets hurt, 15,000 people watch it go badly, and every one of them leaves with a story about whether they're safe at your events. Some stop coming. Some tell others. Some write reviews, and some take it further. You can argue about whether a facilitator is responsible for every emergency in the room. What you can't argue with is what the room expects: that you're ready. People act on that expectation when you aren't. Your events are probably smaller; a festival might hold a few hundred people. The math doesn't change with the size of the room. A rare night, mishandled, can cost you years of work or end it. Those are the two systems a container can't improvise: someone who can help a body in trouble, and someone who can handle conflict. Everything else can be figured out on the night. Those two can't, because by the time you need them, the cost of not having them has already landed. There's a second reason, specific to intimate spaces. When conflict goes unhandled, the fallback is outside help, and [a police car arriving at a sex-positive event is itself a container event](./where-the-police-fit.md#deciding-the-thresholds-before-the-event): participants start wondering whether they're safe, and officers arrive with filters of their own. If you'd rather not depend on that, bring the capability inside: your own specialist and your own security staff, trained before they're needed. This doesn't replace the call for imminent danger; [that threshold is decided before the container starts](./where-the-police-fit.md#when-someone-wont-leave). It covers everything below that line. On most nights you'll never use it. On the night you do, it's standing between a participant and a life-altering night, and between you and the end of your career. Next to that, insurance is cheap.
